...
#ifndef ESP8266GITHUBUPDATE_H_
#define ESP8266GITHUBUPDATE_H_
...
// #define DEBUG_HTTP_UPDATE(msg, ...) Serial.printf(msg)
...
class ESP8266githubUpdate
{
public:
    ESP8266githubUpdate(void);
    ESP8266githubUpdate(int httpClientTimeout);
    // For github update
    ESP8266githubUpdate(String _repo, String _token, String _cert);
    ~ESP8266githubUpdate(void);
    ...
    // Github update
    String getVersion(bool _private, String _filename);
    t_httpUpdate_return git_update(bool _private, const String& file);
...
extern ESP8266githubUpdate ESPgithubUpdate;
#endif
